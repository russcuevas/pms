...
{
     public function AdminJjs2ExpensesPage()
    {
        ...
        return view('admin.jjs2.expenses', compact('expenses'));
    }

    public function AdminJjs2ExpensesRequest(Request $request)
    {
        $request->validate([
            'date' => 'required|date',
    ...
    public function AdminJjs2ExpensesPrintPage()
    {
        $admin = Auth::guard('admins')->user();
        ...
        return view('admin.jjs2.print.expenses', compact('expenses'));
    }
}
