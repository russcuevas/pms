...
{
        public function AdminJjs2PaymentPage(Request $request)
    {
        ...
        return view('admin.jjs2.payments', compact('unit', 'tenant', 'billing'));
    }


    public function AdminJjs2PaymentRequest(Request $request)
{
        $admin = Auth::guard('admins')->user();
    ...
    if ($payment && $payment->email) {
        $html = view('admin.jjs2.emails.payment_invoice', ['payment' => $payment])->render();
