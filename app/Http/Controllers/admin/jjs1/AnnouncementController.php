...
{
    public function AdminJjs1AnnouncementPage()
    {
        ...
        return view('admin.jjs1.announcement', compact('announcements'));
    }

    public function AdminJjs1AnnouncementRequest(Request $request)
    {
        $admin = Auth::guard('admins')->user();
