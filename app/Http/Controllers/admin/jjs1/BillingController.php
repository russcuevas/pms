...
{
     public function AdminJjs1BillingPage(Request $request)
    {
        ...
        return view('admin.jjs1.billing', compact('tenant', 'unit', 'property_id', 'lastTotalBalance'));
    }



    public function AdminJjs1BillingCreate(Request $request)
    {
        $admin = Auth::guard('admins')->user();
        ...
        if ($billing && $billing->email) {
            $html = view('admin.jjs1.emails.billing_invoice', ['billing' => $billing])->render();
