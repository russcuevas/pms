...
{
    public function AdminJjs1RequestPage()
    {
        ...
        return view('admin.jjs1.request', compact('requests'));
    }

    public function AdminJjs1tRequestApprove($id)
    {
        $admin = Auth::guard('admins')->user();
    ...
    public function AdminJjs1RequestDecline($id)
    {
        $admin = Auth::guard('admins')->user();
