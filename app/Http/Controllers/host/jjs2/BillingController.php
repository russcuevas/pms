...
{
    public function HostJjs2BillingPage()
    {
        ...
        return view('host.jjs2.billing', compact('billings'));
    }

    public function HostJjs2ViewPreviousBillings($tenantId)
    {
        $propertyId = 3;
        ...
        return view('host.jjs2.previous_billings', compact('groupedBillings'));
    }
