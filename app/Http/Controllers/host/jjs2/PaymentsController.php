...
class PaymentsController extends Controller
{
    ...
    public function HostJjs2PaymentsPage()
    {
        ...
        return view('host.jjs2.payments', compact('payments'));
    }


    public function HostJjs2ApprovePayment($paymentId)
    {
        ...
        return redirect()->route('host.jjs2.payments.page')->with('success', 'Payment approved, billing updated, and balance reduced.');
    }


    // Decline Payment
    public function HostJjs2DeclinePayment($paymentId)
    {
        $payment = DB::table('payments')->find($paymentId);
        ...
        return redirect()->route('host.jjs2.payments.page')->with('success', 'Payment declined.');
    }
}
