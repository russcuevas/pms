...
{
    public function HostJjs2MonthlySalesComputation(Request $request)
    {
        $propertyId = 3;
    ...
    public function HostJjs2MonthlyExpensesComputation(Request $request)
    {
        $propertyId = 3;
        $year = $request->input('year', date('Y'));  // Default to current year if no year provided
...
public function HostJjs2MonthlyNetIncomeComputation(Request $request)
{
    $propertyId = 3;
...
public function HostJjs2PaymentBreakdown(Request $request)
{
    $propertyId = 3;
    $year = $request->input('year', date('Y'));
