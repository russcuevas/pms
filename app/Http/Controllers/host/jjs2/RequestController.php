...
{
    public function HostJjs2RequestPage()
    {
        // Session check
        ...
        return view('host.jjs2.request', compact('host', 'requests'));
    }


    public function HostJjs2RequestAddressRequest(Request $request, $id)
    {
