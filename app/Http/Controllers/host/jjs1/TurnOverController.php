...
{
        public function Jjs1TurnOverPage()
    {
        ...
        return view('host.jjs1.turn_overs', compact('host', 'turnOvers'));
    }

    public function Jjs1TurnOverApproveRequest($id)
    {
    ...
    public function Jjs1TurnOverDeclineRequest($id)
    {
