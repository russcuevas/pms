...
{
    public function HostJjs1RequestPage()
    {
        // Session check
        ...
        return view('host.jjs1.request', compact('host', 'requests'));
    }


    public function HostJjs1RequestAddressRequest(Request $request, $id)
    {
