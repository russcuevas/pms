...
<body>
    ...
    <div class="container my-4">
        <div class="row g-4">
            ...
            <!-- Cash Payment -->
            <div class="col-md-4">
                <div class="card text-white bg-success h-100" style="background-color: #715A5A !important">
                    <div class="card-body">
        ...
        <div class="row quick-actions g-3">
            ...
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs2.dashboard.page') }}" style="text-decoration: none !important">
            ...
            <!-- Expenses -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs2.expenses.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Units -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs2.units.management.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Payment Proof -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs2.paymemt.proof.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Requests -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs2.request.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Request to Manager -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs2.request_to_manager.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
                        ...
                        <!-- Announcements -->
                        <div class="col-6 col-md-3" >
                            <a href="{{ route('admin.jjs2.announcement.page') }}" style="text-decoration: none !important">
                                <div class="card text-center p-4">
        ...
        $('#turnOverBtn').click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.jjs2.turnover.request') }}",
                        method: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
