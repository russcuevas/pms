...
<head>
    ...
    <title>Tenant Moved Out | Hubert Admin</title>
...
<body>
        ...
        <div class="card shadow-lg border-0">
            <div class="card-body text-center py-5">
                ...
                <div class="d-grid gap-3 d-md-flex justify-content-md-center">
                    <a href="{{ route('admin.hubert.print.billings') }}" class="btn btn-primary btn-lg">
                        <i class="fas fa-file-invoice-dollar me-2"></i> Print Billings PDF
                    </a>
                    <a href="{{ route('admin.hubert.print.payments') }}" class="btn btn-outline-secondary btn-lg">
    ...
    <div class="bottom-nav">
        <a href="{{ route('admin.huberts.dashboard.page') }}">
