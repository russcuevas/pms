...
">
    ...
    <div class="container my-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <form id="follow-up-form" action="{{ route('admin.jjs1.units.follow.up.billings') }}" method="POST">
                @csrf
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.jjs1.billing.page', ['unit_id' => $unit->unit_id, 'tenant_id' => $unit->tenant_id]) }}" class="btn btn-info">
                                        Create Billing
                                    </a>
                                    <a href="{{ route('admin.jjs1.payments.page', ['unit_id' => $unit->unit_id, 'tenant_id' => $unit->tenant_id]) }}" class="btn btn-success">
                                        Create Payment
                                    </a>
            ...
            if (isOccupied) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch('/admin/jjs1/units/transfer-and-repair', {
                            method: 'POST',
                            headers: {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        fetch('/admin/jjs1/units/mark-for-repair', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '{{ csrf_token() }}'
    ...
    document.querySelectorAll('.btn-repaired').forEach(button => {
        button.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('/admin/jjs1/units/mark-as-repaired', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
