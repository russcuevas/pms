    ...
    <div class="container my-4">
        ...
        <div class="row quick-actions g-3">
            ...
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs1.dashboard.page') }}" style="text-decoration: none !important">
            ...
            <!-- Expenses -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs1.expenses.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Units -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs1.units.management.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Payment Proof -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs1.paymemt.proof.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Requests -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs1.request.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
            ...
            <!-- Request to Manager -->
            <div class="col-6 col-md-3">
                <a href="{{ route('admin.jjs1.request_to_manager.page') }}" style="text-decoration: none !important">
                    <div class="card text-center p-4">
                        ...
                        <!-- Announcements -->
                        <div class="col-6 col-md-3" >
                            <a href="{{ route('admin.jjs1.announcement.page') }}" style="text-decoration: none !important">
                                <div class="card text-center p-4">
                        ...
                        <!-- Balance -->
                        <div class="col-6 col-md-3" >
                            <a href="{{ route('admin.jjs1.balance.page') }}" style="text-decoration: none !important">
                                <div class="card text-center p-4">
        ...
        $('#turnOverBtn').click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.jjs1.turnover.request') }}",
                        method: "POST",
                        data: {
                            _token: "{{ csrf_token() }}",
