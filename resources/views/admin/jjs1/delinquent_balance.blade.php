...
<div class="container mt-5">
    <h2 class="mb-4">Delinquent Billings</h2>

    <!-- Filter Buttons -->
    <div class="mb-3">
        <a href="{{ route('admin.jjs1.balance.page') }}" class="btn btn-info">All Billings</a>
        <a href="{{ route('admin.jjs1.balance.paid.page') }}" class="btn btn-success">Paid</a>
        <a href="{{ route('admin.jjs1.balance.delinquent.page') }}" class="btn btn-danger">Delinquent</a>
    </div>

    <div class="table-responsive">
        <table id="delinquentTable" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>SOA No.</th>
                    <th>Name</th>
