...
<body class="bg-light">
    ...
    <div class="container my-4 pb-5">
        ...
        <div class="modal fade" id="proofOfPaymentModal" tabindex="-1" aria-labelledby="proofOfPaymentLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white" style="background-color: #44444E !important">
                        <h5 class="modal-title" id="proofOfPaymentLabel">Send Proof of Payment</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('tenant.jjs1.payment.proof.request') }}" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="row g-3 mb-5">
            <div class="col-6 col-md-3" style="cursor: pointer" data-bs-toggle="modal" data-bs-target="#myProfileModal">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center p-4">
                        <div class="bg-success text-white rounded p-3 mb-3 d-inline-block" style="background-color: #44444E !important">
            ...
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-header text-white" style="background-color: #44444E !important">
            ...
            <div class="col-6 col-md-3" 
                ...
                onclick="window.location.href='{{ route('tenants.jjs1.my-billing.page') }}'">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center p-4">
                        <div class="bg-success text-white rounded p-3 mb-3 d-inline-block" style="background-color: #44444E !important">
            ...
            <div class="col-6 col-md-3" style="cursor: pointer" onclick="window.location.href='{{ route('tenants.jjs1.my-payment.page') }}'">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center p-4">
                        <div class="bg-success text-white rounded p-3 mb-3 d-inline-block" style="background-color: #44444E !important">
    ...
    <nav class="navbar fixed-bottom navbar-light bg-white border-top" style="background-color: #44444E !important">
        <div class="container-fluid">
            <div class="d-flex w-100 justify-content-around">
                <a class="navbar-brand text-success text-center flex-fill border-end" href="{{ route('tenants.jjs1.dashboard.page') }}">
                ...
                <a class="navbar-brand text-white text-center flex-fill" href="{{ route('tenants.jjs1.announcement.page') }}">
    ...
    function selectPayment(method) {
        ...
        if (method === 'Gcash') {
            qrImage = "{{ asset('assets/jjs1/gcash.jpg') }}";
        } else if (method === 'Paymaya') {
            qrImage = "{{ asset('assets/jjs1/paymaya.png') }}";
        } else if (method === 'BDO') {
            qrImage = "{{ asset('assets/jjs1/bdo.jpg') }}";
        }
