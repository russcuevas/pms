<div class="bg-success text-white py-3" style="background-color: #715A5A !important">
        <div class="container">
                        ...
                        <div class="notif-content">
                            @forelse ($notifications as $notif)
                                ...
                                <div class="notif-item" style="text-align: left;">
                                    <div class="notif-text" style="text-align: left;">
                                        ...
                                        @if(!empty($notif->url))
                                            <p style="margin-top: 5px;">
                                                <a href="{{ route('admin.jjs2.notification.view', $notif->id) }}" style="color: #007bff; text-decoration: underline;">
                                    ...
                                    <form action="{{ route('admin.jjs2.notification.delete', $notif->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
