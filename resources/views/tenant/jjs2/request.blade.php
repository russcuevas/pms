...
<table id="requestTable" class="table table-bordered table-striped">
    ...
    <div class="modal fade" id="requestModal" tabindex="-1" aria-labelledby="requestModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form class="needs-validation" novalidate action="{{ route('tenants.jjs2.my-request.post') }}" method="POST">
                @csrf
    ...
    <nav class="navbar fixed-bottom navbar-light bg-white border-top" style="background-color: #715A5A !important">
        <div class="container-fluid">
            <div class="d-flex w-100 justify-content-around">
                ...
                <a class="navbar-brand text-success text-center flex-fill border-end" href="{{ route('tenants.jjs2.my-request.page') }}">
