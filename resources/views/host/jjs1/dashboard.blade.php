...
<div class="container my-4">
    ...
    <div class="row quick-actions g-3">
        ...
        <!-- Admin Management -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.admin.management.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Admin Requests -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.request_to_manager.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Turnovers -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.turnover.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Billing -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.billing.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Payments -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.payments.page')}}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Expense Details -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.expenses.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Announcements -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.announcement.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Requests -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.request.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Payment Proof -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs1.paymemt.proof.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
...
<script>
    function updatePaymentData(year) {
        fetch(`/host/jjs1/payment-breakdown?year=${year}`)
