    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="info-box" onclick="window.location='{{ route('host.jjs1.tenant-billing-history.page') }}'">
            ...
            <!-- Tenant Payments -->
            <div class="col-md-6 mb-4">
                <div class="info-box" onclick="window.location='{{ route('host.jjs1.tenant-payment-history.page') }}'">
