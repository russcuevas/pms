...
<body>
    ...
    <div class="container my-5">
        <h2>Balance Table</h2>
        <div class="mb-4">
            <a href="{{ route('host.jjs2.balance.page') }}" class="btn btn-info">All Billings</a>
            <a href="{{ route('host.jjs2.balance.paid.page') }}" class="btn btn-success">Paid</a>
            <a href="{{ route('host.jjs2.balance.delinquent.page') }}" class="btn btn-danger">Delinquent</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        @if ($billing->status === 'paid')
                            <span class="badge bg-success text-uppercase">{{ $billing->status }}</span>
                        @else
                            <span class="badge bg-danger text-uppercase">{{ $billing->status }}</span>
                        @endif
                    </td>
                    <td>
...
<script>
    $(document).ready(function () {
        $('#balanceTable').DataTable({
            ...
            columnDefs: [
                { responsivePriority: 1, targets: 0 }, // SOA No.
