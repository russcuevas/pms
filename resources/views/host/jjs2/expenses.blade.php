  ...
  <div class="container my-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h2 class="mb-4">Expenses Management</h2>
            <div>
                <a href="{{ route('host.jjs2.print.expenses') }}" target="_blank" class="btn btn-secondary">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              @else
                <form action="{{ route('host.jjs2.expenses.approve', $expense->id) }}" method="POST" style="display:inline;">
                  @csrf
                  <button type="submit" class="btn btn-success btn-sm" onclick="return confirm('Approve this expense?')">Approve</button>
                </form>

                <form action="{{ route('host.jjs2.expenses.decline', $expense->id) }}" method="POST" style="display:inline;">
                  @csrf
                  @method('DELETE')
