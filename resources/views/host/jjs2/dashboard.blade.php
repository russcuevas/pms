...
<div class="container my-4">
    ...
    <div class="row quick-actions g-3">
        <div class="col-12 col-md-12">
            <a href="{{ route('host.jjs2.tenant-history.page')}}" style="text-decoration: none !important">
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.dashboard.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Admin Management -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.admin.management.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Admin Requests -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.request_to_manager.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Turnovers -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.turnover.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Billing -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.billing.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Payments -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.payments.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Expense Details -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.expenses.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Announcements -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.announcement.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Requests -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.request.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Payment Proof -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.paymemt.proof.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
        ...
        <!-- Balance -->
        <div class="col-6 col-md-3">
            <a href="{{ route('host.jjs2.balance.page') }}" style="text-decoration: none !important">
                <div class="card text-center p-4">
    ...
    <div class="mb-3">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="card text-white h-100" style="background-color: #715A5A">
                    <div class="card-body">
